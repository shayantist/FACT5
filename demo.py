...
def main():
    ...
    complex_examples = [
        ...
        "A significant portion of the internet's content is generated by AI or bots. The date given for this death is generally around 2020.",
        ...
        "The ACL 2025 conference is taking place in San Francisco and focuses solely on research involving ACL injuries."
    ]
    ...
    with complex_col4:
        if st.button("🧑‍💻 ACL 2025", help=complex_examples[3]):
